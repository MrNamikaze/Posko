...
if(is_null($_SESSION["user"])){
    ...
    $sql = "SELECT * FROM hospital LIMIT ".$hasil3['filter_hospital'];
    $row = $db->prepare($sql);
    $row->execute();
    $hasil = $row->fetchAll();
}
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <table class="table">
                          ...
                          <tbody>
                            <?php for($a = 0; $a < $hasil3['filter_hospital']; $a++):?>
                            <tr>
                              <th scope="row"><?= $a+1;?></th>
                              <td><?= $hasil[$a]["name_hospital"];?></td>
                              <td><?= $hasil[$a]["line_hospital"];?></td>
                              <td><?= $hasil[$a]["city_hospital"];?></td>
                              <td><a href='rumah_sakit.php?id=<?= $hasil[$a]["id_hospital"];?>' class="btn btn-primary">Click</a></td>
                            </tr>
                            <?php endfor;?>
                          </tbody>
                        </table>
